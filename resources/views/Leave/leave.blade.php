                        ...
                        <form class="space-y-6">
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <x-forms.select-input
                                    ...
                                    :options="$leaveTypes"
                                    :selected="old('leave_type', $currentLeaveType ?? '')"
                                />
                            ...
                            <div class="pt-6 border-t border-gray-200 dark:border-gray-700">
                                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                                    <x-button type="primary" class="w-full sm:w-auto px-8 py-3 text-base font-medium">
                                    ...
                                    <button type="button" class="w-full sm:w-auto px-8 py-3 text-base font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-lg transition-colors duration-200">
